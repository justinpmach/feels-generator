    ...
    <>
      ...
      <main>
        <div className="container mx-auto grid grid-cols-2 gap-3">
          <form
            className="container flex flex-col rounded-md border bg-blue-500 bg-opacity-50 p-8"
          ...
          <div className="flex">
            ...
            <section className="mx-auto mb-8 grid grid-cols-4 gap-4 rounded-md border border-red-400 bg-neutral-700 p-8 shadow-md">
              {imagesUrl.length > 0 ? (
                <>
        ...
        <div className="flex h-64 items-center justify-center bg-yellow-500">
          <a id="feel" className="word fancy">
            Capture the feeling
          </a>
        </div>
